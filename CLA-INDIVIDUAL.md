...
Thank you for your interest in contributing to OpenLithoHub (the "Project").
This Contributor License Agreement ("Agreement") documents the rights granted
by contributors to the Project maintainers.
...
to the Project for inclusion in, or documentation of, the Project.
...
Your Contributions as part of commercially licensed versions of the Project,
while the open-source version remains freely available under its original
license (Apache License 2.0 for code, CC-BY-SA 4.0 for documentation).
...
Your Contributions include complete details of any third-party license or
...
license or restriction associated with any part of Your Contribution. For
new dataset adapters, you agree to add the dataset's original license and
...
To sign this CLA, submit a pull request to this repository. The CLA Assistant
bot (once configured) will ask you to confirm by commenting on the PR:
