...
> Colab BYOM: [notebooks/colab_byom.ipynb](../../notebooks/colab_byom.ipynb)
...
- **Models** — `dummy-identity`, `rule-based-opc` (directional
  ...
  `levelset-ilt`, `neural-ilt`. All conform to the same
  `LithographyModel` interface; bring-your-own in <50 lines.
